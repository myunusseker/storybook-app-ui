...
import { 
  Play, Pause, SkipBack, SkipForward, Heart, Share, 
  ArrowLeft, Volume2, Moon, Star 
...
export default function StoryPlayerScreen() {
  ...
  // Optional gesture support for Android
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerActions}>
            <TouchableOpacity style={styles.headerButton} onPress={() => setIsNightMode(!isNightMode)}>
        ...
        <View style={styles.playerContainer}>
          ...
          <View style={styles.controlsContainer}>
            <TouchableOpacity style={styles.controlButton} onPress={() => setIsFavorite(!isFavorite)}>
              <Heart 
                size={24} 
